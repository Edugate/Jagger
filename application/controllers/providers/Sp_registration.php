...
class Sp_registration extends MY_Controller {
    ...
    public function index()
    {
        ...
        if ($this->_submit_validate() === TRUE)
        {
            ...
            $contact_fname = $this->input->post('contactfname');
            $contact_lname = $this->input->post('contactlname');
            ...
            $contact->setGivenName($contact_fname);
            $contact->setSurName($contact_lname);
    ...
    private function _submit_validate()
    {
        ...
        $this->form_validation->set_rules('contactlname', '' . lang('rr_contactlastname') . '', 'required|trim|min_length[1]|max_length[255]');
        $this->form_validation->set_rules('contactfname', '' . lang('rr_contactfirstname') . '', 'required|trim|min_length[1]|max_length[255]');
