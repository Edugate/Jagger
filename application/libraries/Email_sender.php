...
class Email_sender
{
    ...
    /**
     * @param null $notificationTypes
     * @param null $obj
     * @param $subject
     * @param $body
     * @param $additionalReciepients
     * @param bool $sync
     * @return bool
     */
    function addToMailQueue($notificationTypes = NULL, $obj = NULL, $subject, $body, $additionalReciepients, $sync = false)
    {
        ...
        } elseif (is_array($notificationTypes)) {
        ...
        $subscribers = $this->em->getRepository("models\NotificationList")->findBy(
            array('type' => $finalNotificationTypes, 'is_enabled' => true, 'is_approved' => true, 'notificationtype' => 'mail'));
    ...
    function providerIsModified(\models\Provider $ent, \models\Tracker $tracker)
    {
        ...
        $body = 'Dear user,' . PHP_EOL;
        $body .= 'Provider (' . $ent->getEntityId() . ' has been modified by ' . $this->ci->jauth->current_user() . ' from ' . $this->ci->input->ip_address() . PHP_EOL . PHP_EOL;
