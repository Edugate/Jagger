...
google.maps.event.addListener(map'.$_key.',\'click\',function(zdarzenie)
    {
        dymek.setContent(\'Location :<br />\'+zdarzenie.latLng); 
        document.getElementById(\'latspan\').innerHTML = zdarzenie.latLng.lat();
        document.getElementById(\'lngspan\').innerHTML = zdarzenie.latLng.lng();
        $(\'#latinput\').val(zdarzenie.latLng.lat());
        $(\'#lnginput\').val(zdarzenie.latLng.lng());
