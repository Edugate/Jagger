...
?>
<button type="submit" value="remove" name="remove" class="button alert" ><?php echo lang('rr_remove');?></button>
<?php
echo '<a href="'.base_url().'manage/statdefs/statdefedit/'.$providerid.'/'.$defid.'" class="button">'.lang('rr_edit').'</a>';
echo form_close();
echo '</div>';
}
?>
