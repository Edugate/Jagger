...
<?php
echo '<script type="text/javascript" src="' . $base_url . 'js/f6-thirdpartylibs.min.4510195e.js"></script>' . PHP_EOL;
...
echo '<script type="text/javascript" src="' . $base_url . 'js/local-f6.min.bef76ef3.js"></script>' . PHP_EOL;
