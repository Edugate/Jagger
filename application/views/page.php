...
<?php
echo '<script type="text/javascript" src="' . $base_url . 'js/f6-thirdpartylibs.min.efae0a01.js"></script>' . PHP_EOL;
...
echo '<script type="text/javascript" src="' . $base_url . 'js/local-f6.min.7dcd4068.js"></script>' . PHP_EOL;
