            ...
            <ul class="right">
                ...
                if ($loggedin) {
                    ...
                    <li class="has-dropdown">
                        ...
                        <ul class="dropdown">
                            <li>
                                <a href="<?php echo $base_url . 'manage/users/show/' . base64url_encode($user) . ''; ?>"><?php echo lang('myprofile'); ?></a>
                            </li>
                            <li>
            ...
            <ul class="left">
                ...
                if ($loggedin) {
                    ...
                    <ul class="dropdown">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo $base_url; ?>manage/ec/show"><?php echo lang('entattrs_menulink'); ?></a>
                        </li>
                        <li>
